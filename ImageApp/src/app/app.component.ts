...
function () {
    ...
    function buildThumbnailNode(index, imageDatum, targetImageRow) {
        ...
        image.addEventListener("load", function (evt) {
            ...
            if (imageData.every(function (datum) { return datum.loaded; })) {
                ...
                if(itemsReturned < 20) { //Presumably, if Google Images API returned less than 10 items (even though we've asked for 10), we've hit the end of the possible images
    ...
    function loadDoc() {
        ...
        // params.key = "AIzaSyD6O2lmedIhV5v905oMpoRfgIns5Hpc9Rs";
        params.key = "AIzaSyDKjABE3g5lzk87W_8robuanXCTad6fEV8";
        
         // API_KEY got from https://console.developers.google.com/
        params.cx = "014247353093954254332:_ax3nagvpek";
        // params.cx = "009337507404596127428:aj0j7_ksymu";
        
        // <script>
  
        
         // cx value is the custom search engine value got from https://cse.google.com/cse(if not created then create it).
